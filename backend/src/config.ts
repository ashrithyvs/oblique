...
export const GOAL_PROGRESS_RATE_LIMIT_MAX = process.env.GOAL_PROGRESS_RATE_LIMIT_MAX ? Number(process.env.GOAL_PROGRESS_RATE_LIMIT_MAX) : 60;
export const GOAL_PROGRESS_RATE_LIMIT_WINDOW_MS = process.env.GOAL_PROGRESS_RATE_LIMIT_WINDOW_MS ? Number(process.env.GOAL_PROGRESS_RATE_LIMIT_WINDOW_MS) : 60 * 1000;
